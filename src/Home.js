...
const Home = () => {
  ...
  return (
    <>
      <VisualQueue/>
          <button onClick={get_connected_address} style={{ marginTop: '2rem', backgroundColor: 'red', border: 0, height: '3rem', width: 'auto', borderRadius: '.2rem', color: 'white', boxShadow: '1px 1px 7px black', position: 'absolute', right: '1rem', top: '0rem' }}><h4>{connect_btn_state}</h4></button>
