  ...
  return (
    <div >
      ...
      <form style={{
        ...
        <input placeholder='Pickup Address' onChange={(e) => {
          setPickupAddress(e.target.value);
        }} className='input_'></input>
        
        <input placeholder='Dropoff Address' onChange={(e) => {
        ...
        <div>
        <input placeholder='Contact Number' onChange={(e) => {
        ...
        <label for="appt"><h3>Pickup time:</h3></label>
          <input onChange={(e) => {
          setPickupTime(e.target.value);
        }} className='input_'  type="time" id="appt" name="appt"></input>

          <a href='#'><p>By clicking confirm you agree to our terms and conditions.</p></a>

        <button onClick={book_apex} style={{ marginTop: '2rem', backgroundColor: 'red  ', border: 0, height: '3rem', width: '8rem', borderRadius: '.2rem', color: 'white', boxShadow: '1px 1px 7px black', cursor: 'pointer' }}><h4>Confirm Apex</h4></button>
